...
local themes = {
	index = {'Dark', 'VioletPulse', 'Amethyst'},
	VioletPulse = {
	   ['Shadow'] = Color3.fromRGB(20, 18, 28),
    ['Background'] = Color3.fromRGB(25, 22, 38),
    ['Page'] = Color3.fromRGB(20, 18, 28),
    ['Main'] = Color3.fromRGB(138, 43, 226), -- vibrant purple
    ['Text & Icon'] = Color3.fromRGB(245, 245, 245),
    ['Function'] = {
        ['Toggle'] = {
            ['Background'] = Color3.fromRGB(25, 22, 38),
            ['True'] = {
                ['Toggle Background'] = Color3.fromRGB(72, 31, 135),
                ['Toggle Value'] = Color3.fromRGB(138, 43, 226),
            },
            ['False'] = {
                ['Toggle Background'] = Color3.fromRGB(36, 32, 50),
                ['Toggle Value'] = Color3.fromRGB(55, 46, 70),
            }
        },
        ['Label'] = {
            ['Background'] = Color3.fromRGB(25, 22, 38),
        ...
        ['Dropdown'] = {
            ...
            ['Dropdown Select'] = {
                ...
                ['Search'] = Color3.fromRGB(32, 28, 45),
                ['Item Background'] = Color3.fromRGB(50, 42, 68),
            }
        },
        ['Slider'] = {
            ['Background'] = Color3.fromRGB(25, 22, 38),
            ['Value Background'] = Color3.fromRGB(20, 18, 28),
            ['Value Stroke'] = Color3.fromRGB(245, 245, 245),
            ['Slider Bar'] = Color3.fromRGB(72, 31, 135),
            ['Slider Bar Value'] = Color3.fromRGB(138, 43, 226),
            ['Circle Value'] = Color3.fromRGB(245, 245, 245)
        },
        ['Code'] = {
            ['Background'] = ColorSequence.new{
                ColorSequenceKeypoint.new(0, Color3.fromRGB(25, 22, 38)), 
                ColorSequenceKeypoint.new(1, Color3.fromRGB(25, 22, 38))
            },
            ['Background Code'] = Color3.fromRGB(60, 40, 110),
            ['Background Code Value'] = Color3.fromRGB(45, 30, 90),
            ['ScrollingFrame Code'] = Color3.fromRGB(200, 180, 255)
        },
        ['Button'] = {
            ['Background'] = Color3.fromRGB(25, 22, 38),
...
do
	...
	local IconList = loadstring(game:HttpGet('https://raw.githubusercontent.com/UnknownVg/CUSTOM-2-LIB/refs/heads/main/Add-ons/Icon.lua'))()
	function gl(i)
...
function Library:Window(p)
	...
	local Theme = p.Theme or 'VioletPulse'
